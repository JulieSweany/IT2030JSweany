...
namespace MovieStore.Controllers
{
    public class MoviesController : Controller
    {
        ...
        //Used by application at run time
        ...
        //Added for tests to prove ListFromDb creates list of movies
        ...
        //Added for tests to prove RedirectToAction in POST: Create works
        ...
        //Add method to test adding movie
        public Object MovieEntry()
        {
            //Movie addedMovie = new Movie { MovieId = 1, Title = "Black Panther" };
            db.Movies.Add(new Movie { MovieId = 1, Title = "Black Panther" });
